      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center text-center space-y-8 max-w-2xl mx-auto">
          ...
          <div className="space-y-4">
            <h1 className="text-8xl md:text-9xl font-black text-amber-500 opacity-50">
              404
            </h1>
          ...
          <div className="bg-gradient-to-r from-amber-500/20 to-yellow-300/20 p-6 rounded-lg border border-amber-500/30 max-w-md mx-auto">
            <p className="text-zinc-300 text-sm mb-2">
              Don't forget our referral code:
            </p>
            <div className="text-2xl font-black text-amber-500 tracking-wider">
              vCW7t38771
            </div>
            <p className="text-zinc-400 text-xs mt-2">
              Use this code when registering for exclusive bonuses!
            </p>
          </div>
          ...
          {/* Quick Links */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full max-w-lg text-sm">
            <Link
              href="/"
